...
import { PremiumCursor } from "@/components/effects/cursor";
      ...
      <div className="min-h-screen flex flex-col chess-pattern-bg grain-overlay">
        ...
        <header className="sticky top-0 z-50"
          ...
          <div className="h-px w-full"
            style={{ background: "linear-gradient(to right, transparent 0%, rgba(201,168,76,0.55) 30%, rgba(201,168,76,0.55) 70%, transparent 100%)" }} />
                ...
                return (
                  ...
                  >
                    ...
                    {isActive && (
                      <motion.span
                        layoutId="nav-active"
                        className="absolute bottom-0 left-1/2 -translate-x-1/2 h-0.5 rounded-full w-4"
              ...
              {player ? (
                ...
                >
                  ...
                  <div className="hidden sm:block">
                    ...
                    <div className="text-[10px] font-black leading-tight gradient-text-gold">{player.rating}</div>
                  </div>
                </Link>
              ) : (
                <Link href="/auth">
        ...
        {/* ── Content ── */}
        <motion.main
          className="flex-1 max-w-7xl w-full mx-auto px-4 py-8 pb-24 md:pb-8"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
            ...
            {player && (
              ...
              >
                <div className="w-5 h-5 rounded-md flex items-center justify-center font-black text-[9px]"
                  style={{
                    background: location.startsWith("/profile") ? "rgba(16,185,129,0.25)" : "rgba(255,255,255,0.07)",
        ...
        <footer className="hidden md:block" style={{ borderTop: "1px solid rgba(255,255,255,0.04)", background: "rgba(6,8,16,0.5)" }}>
          <div className="max-w-7xl mx-auto px-5 py-6 flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              <span style={{ fontFamily: "'Cinzel', serif", fontWeight: 800, fontSize: "0.85rem", opacity: 0.35 }}>
                <span style={{ color: "#E2E8F4" }}>Chess</span>
                <span style={{
                  background: "linear-gradient(135deg, #C9A84C, #E8C875)",
                  WebkitBackgroundClip: "text",
              ...
              <span className="text-[11px] text-muted-foreground/35">Elite chess · Real rivals · No bots</span>
            </div>
            <div className="flex items-center gap-6 text-[11px] text-muted-foreground/30">
